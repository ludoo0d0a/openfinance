...
export const SCHEMES: Scheme[] = [
  ...
  {
    id: 'paypal',
    name: { en: 'Digital Wallet (PayPal, Apple Pay, Google Pay)', fr: 'Wallet numérique (PayPal, Apple Pay, Google Pay)' },
    operator: 'Wallet providers (PayPal, Apple, Google, Alipay)',
    summary: {
      en: 'Third-party digital wallet / PSP scheme (e.g. PayPal, Apple Pay, Google Pay, Alipay). The merchant sees the wallet/PSP as acquirer of record; funding may hit a card scheme, bank account, or wallet balance. Merchant payout is often a later credit transfer.',
      fr: 'Schéma wallet / PSP tiers (ex. PayPal, Apple Pay, Google Pay, Alipay). Le commerçant voit le wallet comme acquéreur de record ; le funding peut taper un schéma carte, un compte ou le solde wallet. Le paiement commerçant est souvent un virement plus tard.',
    },
